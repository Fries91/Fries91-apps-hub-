...
(function () {
  ...
  function hideStandaloneLaunchers() {
    try {
      ['#warhub-shield', '#warhub-badge', '#si-pda-launcher', '#giveaway-shield'].forEach((sel) => {
